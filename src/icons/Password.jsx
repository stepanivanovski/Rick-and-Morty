export const IconPassword = ({ className = '' }) => {
  return (
    ...
    <path d="M19.393 15.696V13.962C19.393 12.878 18.514 11.999 17.43 11.999C16.346 11.999 15.467 12.878 15.467 13.962V15.696" stroke="#5B6975" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>

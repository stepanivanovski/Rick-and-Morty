  ...
  return (
    <div>
      ...
      >
        ...
        <path
          className={className}
          d="M12.617 12.6151C12.7775 12.4546 12.7775 12.1936 12.6155 12.0346C12.455 11.8741 12.194 11.8741 12.0335 12.0346C11.873 12.1951 11.873 12.4561 12.0335 12.6166C12.194 12.7771 12.455 12.7771 12.617 12.6151Z"
          stroke="#0B1E2D"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"

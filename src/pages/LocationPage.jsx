...
import { resetLocation, getLocationByIdThunk } from '../store/locationsSlice'
    ...
    <div className="loc-page">
      <div className="loc-page__header">
        <div className="loc-page__header-img">
          {location?.name ? (
            <img src={location?.imageName} alt={location?.name} />
          ) : null}
        </div>
...
const View = ({ location }) => {
  const { name, type, measurements, about, characters } = location
  ...
  return (
    <div className="loc-page__content">
      <div className="container">
        ...
        <p className="loc-page__descr text_main-13px">{about}</p>
